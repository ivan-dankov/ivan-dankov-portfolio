...
export default function About() {
  return (
    <div className="min-h-screen">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 pt-28 md:pt-44 lg:pt-52 pb-24">

        {/* Intro */}
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-x-12 mb-32">
          {/* Photo */}
          ...
          <div className="lg:col-span-7 flex flex-col justify-between">
            ...
            >
              <h1 className="text-3xl md:text-5xl font-normal tracking-tight leading-[1.2] mb-12"
                style={{ fontFamily: "var(--font-serif, 'DM Serif Display', Georgia, serif)" }}
              >
                I build tools for people who make high-stakes decisions with messy data.
              </h1>

              <div className="space-y-6 text-lg text-[#4A4A4A] leading-relaxed max-w-2xl">
                <p>
                  I've spent 10 years designing complex interfaces. For the last 4.5 years at Sift, I worked on fraud detection, analytics, and design systems—helping analysts fight digital abuse at scale.
                </p>
                <p>
                  I'm currently based in Warsaw, looking for a Senior/Staff role at a company that values testing before scaling polish.
                </p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="mt-12 lg:mt-auto pt-8 border-t border-[#E8E8E4]"
            >
        ...
        <Separator className="bg-[#E8E8E4] mb-24" />

        {/* Experience */}
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-y-8 lg:gap-x-12 mb-32">
          <div className="lg:col-span-3">
            <h2 className="text-sm font-medium uppercase tracking-[0.2em] text-[#6B6B6B] sticky top-32">Experience</h2>
          </div>
              ...
              >
                ...
                <div className="md:col-span-8">
                  <div className="flex items-baseline justify-between mb-2">
                    <p className="text-lg font-medium text-[#1A1A1A]">{exp.role}</p>
                  </div>
                  <p className="text-[#4A4A4A] leading-relaxed">{exp.desc}</p>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-y-8 lg:gap-x-12 mb-32">
          <div className="lg:col-span-3">
            <h2 className="text-sm font-medium uppercase tracking-[0.2em] text-[#6B6B6B] sticky top-32">Tools</h2>
          </div>
          <div className="lg:col-span-9">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-12">
              {toolGroups.map((group, i) => (
                <div key={i}>
                  <p className="text-sm text-[#1A1A1A] font-medium mb-4">{group.label}</p>
                  <div className="flex flex-wrap gap-2">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-y-8 lg:gap-x-12 mb-32">
          <div className="lg:col-span-3">
            <h2 className="text-sm font-medium uppercase tracking-[0.2em] text-[#6B6B6B] sticky top-32">Testimonials</h2>
          </div>
        ...
        {/* Contact */}
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-y-8 lg:gap-x-12">
          <div className="lg:col-span-3">
            <h2 className="text-sm font-medium uppercase tracking-[0.2em] text-[#6B6B6B]">Contact</h2>
          </div>
          <div className="lg:col-span-9">
            <SocialLinks />
            <p className="text-[#6B6B6B] text-sm mt-8 max-w-md">
              Open to discussion about Product Design leadership roles in B2B SaaS, FinTech, and Data tools.
            </p>
          </div>
        </section>
